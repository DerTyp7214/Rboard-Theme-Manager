...
class AuthLoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_auth_login, container, false)
        ...
        buttonLogin.setOnClickListener {
            ...
            // TODO: backend to login
            Handler().postDelayed({
                controller.navigate(R.id.action_authLoginFragment_to_authFailedFragment)
